import { describe, expect, it, beforeEach, afterEach, spyOn } from "vitest"
import * as fs from "node:fs"
import * as os from "node:os"
import * as path from "node:path"

import * as configDir from "../../shared/opencode-config-dir.js"
import { readOpencodeConfigAgents } from "./opencode-config-agents-reader.js"
...
describe("readOpencodeConfigAgents", () => {
  ...
  beforeEach(() => {
    ...
    configDirSpy = vi.spyOn(configDir, "getOpenCodeConfigDir").mockReturnValue(mockGlobalConfigDir)
  })
